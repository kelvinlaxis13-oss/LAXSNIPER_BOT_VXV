...
import { useDerivStore } from '@/external/masterbot/store/useDerivStore';
...
const LaxSniperXV = lazy(() => import('../laxsniper-xv/page'));
...
const AppWrapper = observer(() => {
    ...
    const { isOAuth2Enabled } = (useOauth2() as any);
                ...
                >
                    <div>
                        ...
                        <Tabs 
                            ...
                            top 
                            history={{ push: navigate, replace: navigate, location } as any}
                        >
                            <div
                                label={
                                    <>
                                ...
                                label={
                                    <>
                                        <LabelPairedChartLineCaptionRegularIcon
                                            ...
                                            fill='var(--text-general)'
                                        />
                                        <Localize i18n_default_text='LAXSNIPER XV' />
                                    </>
                                }
                                id='id-laxsniper-xv'
                            >
                                <div className='laxsniper-xv-wrapper'>
                                    <Suspense
                                        fallback={
                                            <ChunkLoader message={localize('Please wait, loading LAXSNIPER XV...')} />
                                        }
                                    >
                                        <LaxSniperXV />
                                    </Suspense>
