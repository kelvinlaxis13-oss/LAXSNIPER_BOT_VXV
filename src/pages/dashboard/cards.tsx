...
import DBotText from '@/components/shared_ui/text';
...
const Cards = observer(({ is_mobile, has_dashboard_strategies }: TCardProps) => {
    ...
    return React.useMemo(
                    ...
                    {actions.map(icons => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <DBotText color='prominent' size={is_mobile ? 'xxs' : 'xs'}>
                                    {content}
                                </DBotText>
                            </div>
                        );
        ...
        [is_dialog_open, has_dashboard_strategies, isDesktop, is_mobile, dialog_options, onCloseDialog, setPreviewOnPopup]
    );
});
